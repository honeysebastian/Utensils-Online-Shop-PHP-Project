...
<head>
	<title>User - Homepage-Utensils Shop</title>
	<!-- custom-theme -->
		...
		<div class="wrapper_top_w3layouts">
			...
			<div class="header_agileits">
				...
				<div class="overlay overlay-contentpush">
					...
					<nav>
						<ul>
						<ul><?php session_start();if(isset($_SESSION['EMAIL'])){$id=$_SESSION['EMAIL'];echo "Email: <input type='text' readonly value='$id'>";}else header("Location: ../login/sign_in.php");?>
						    
							<li><a href="../Homepage/index.php" class="active">Home</a></li>
				...
				<!-- <div class="top_nav_right">
					<div class="shoecart shoecart2 cart cart box_1">
						<form action="cart_one.php" method="post" class="last">
