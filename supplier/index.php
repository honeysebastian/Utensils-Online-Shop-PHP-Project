...
<head>
	<title>Supplier- Homepage-Utensils Shop</title>
	<!-- custom-theme -->
		...
		<div class="wrapper_top_w3layouts">
			...
			<div class="header_agileits">
				...
				<div class="overlay overlay-contentpush">
					...
					<nav>
						<ul><?php session_start();if(isset($_SESSION['supplier_mail'])){$id=$_SESSION['supplier_mail'];echo "Email: <input type='text'
						readonly value='$id'>";}else header('Location: ../login/sign_in.php');?>
						
							<li><a href="index.php" class="active">Home</a></li>
							<li><a href="view_profile.php">View Profile</a></li>
							<li><a href="viewww_reorder_request.php"> View order request</a></li>
							<!-- <li><a href="../Homepage/index.php">Visit Site</a></li> -->
