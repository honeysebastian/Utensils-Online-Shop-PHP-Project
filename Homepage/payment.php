				...
				<div class="responsive_tabs">
					<div id="horizontalTab">
						...
						<div class="resp-tabs-container">
							...
							<div class="tab1">
								<div class="pay_info">
									<div class="vertical_post check_box_agile creditly-card-form">
										<h4>COD</h4>
										<div class="checkbox">
										<h4>No Issues!</h4><span>You can pay the bill at the time of delivery.</span> 
											
										</div>
										
										<a class="btn btn-primary" href="<?php echo "order_payment.php"; ?>">Confirm Order</a>
							...
							<div class="tab2">
								<div class="pay_info">
									<form action="order_payment.php" method="post" class="creditly-card-form agileinfo_form">
										<section class="creditly-wrapper wthree, w3_agileits_wrapper">
											<div class="credit-card-wrapper">
												<div class="first-row form-group">
													<div class="controls">
														<label class="control-label">Name on Card</label>
														<input class="billing-address-name form-control" type="text" name="name" placeholder="Card Name" required="" pattern="[A-Za-z\s]+">
													</div>
													<div class="w3_agileits_card_number_grids">
														<div class="w3_agileits_card_number_grid_left">
															<div class="controls">
																<label class="control-label">Card Number</label>
																<input class="number credit-card-number form-control" type="text" name="number" required="" inputmode="numeric" autocomplete="cc-number"
														...
														<div class="w3_agileits_card_number_grid_right">
															<div class="controls">
																...
																<input class="security-code form-control" Â· inputmode="numeric" type="text" required=""  name="security-code"  placeholder="&#149;&#149;&#149;">
															</div>
														</div>
														<div class="clear"> </div>
													</div>
													<div class="controls">
														...
														<input class="expiration-month-and-year form-control" type="month" name="expiration-month-and-year" placeholder="MM / YY" required min="2022-07" max="2030-12" value="2022-07" >
													</div>
												</div>
												<a class="btn btn-primary" href="<?php echo "order_payment.php"; ?>">Make a Payment</a>
											</div>
										</section>
									</form>
