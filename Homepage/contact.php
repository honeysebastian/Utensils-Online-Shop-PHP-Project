		...
		<div class="shop_inner_inf">
			...
			<div class="inner_section_w3ls">
				<div class="col-md-7 contact_grid_right">
					...
					<form action="../contact_con.php" method="post">
						
					
							<input type="text" name="name" placeholder="Name" pattern="[A-Za-z\s]+" required>
							<input type="text" name="phn" placeholder="Telephone" required="" pattern="[0-9]+" minlength="10" maxlength="10">
