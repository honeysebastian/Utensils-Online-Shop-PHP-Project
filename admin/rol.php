         ...
         <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title"> Reorder List</h4>
                  ...
                  <table class="table tablesorter " id="page1">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($conn,"select product_id,product_image, product_title,product_price,product_count from products where product_count<=rol")or die ("query 1 incorrect.....");
								
								while($row = mysqli_fetch_assoc($result))
                        {
							
					
                        echo "<tr><td><img src='./product_images/".$row['product_image']."' style='width:50px; height:50px'; border:groove #000'></a></td><td>".$row['product_title']."</td>
                        <td>".$row['product_price']."</td><td>".$row['product_count']."</td>
                        <td>
                        <a href='reorder_request.php?product_id=".$row['product_id']."&product_title=".$row['product_title']."'><button class='btn btn-sm btn-outline-primary pull-right'>
              Notify Supplier                     
     </button></a>
                        </td> </tr>";
                    }
